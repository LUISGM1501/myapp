...
const CrearReunion = () => {
  ...
  const handleCrearReunion = async () => {
    ...
    try {
      const response = await axios.get(`https://requebackend-da0aea993398.herokuapp.com/api/proyecto/${proyectoId}`);
      ...
      const posting = await axios.post('https://requebackend-da0aea993398.herokuapp.com/api/reunion', datos);
      if (!posting.data) {
        console.log('datos: ', datos);
        return; // Salir de la función temprano si no se encontró el proyecto
      }
