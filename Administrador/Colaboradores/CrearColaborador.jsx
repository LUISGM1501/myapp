...
const CrearColAd = () => {
  ...
  const handleGuardar = async () => {
    ...
    try {
      const url = tipoUsuario === 'colaborador' ? 'https://requebackend-da0aea993398.herokuapp.com/api/colaborador/' : 'https://requebackend-da0aea993398.herokuapp.com/api/admin/';
